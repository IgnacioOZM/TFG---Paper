...
\begin{figure}[ht]
  \subfloat[Esquema del IRB120]{
	\begin{minipage}[c][1\width]{0.45\textwidth}
	   \centering
	   \includegraphics[width=1\textwidth]{EstadoDelArte/IRB120_esquema.png}
	\end{minipage}}
  \hfill	
  \subfloat[Cabezal del IRB120]{
	\begin{minipage}[c][1\width]{0.45\textwidth}
	   \centering
	   \includegraphics[width=1\textwidth]{EstadoDelArte/IRB120_cabezal.png}
	\end{minipage}}
